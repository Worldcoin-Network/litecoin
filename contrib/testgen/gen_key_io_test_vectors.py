...
bech32_templates = [
  ...
  ('wdc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('wdc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('wdc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('twdc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('twdc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('twdc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rwdc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rwdc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rwdc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('twdc',  17, 32, False, False, False),
  ('rwdc',  3,  1, False, False, False),
  ('wdc',   15, 41, False, False, False),
  ('twdc',  0, 16, False, False, False),
  ('rwdc',  0, 32, True,  False, False),
  ('wdc',   0, 16, True,  False, False),
  ('twdc',  0, 32, False, True,  False),
  ('rwdc',  0, 20, False, False, True)
]
