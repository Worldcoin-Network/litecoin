# Support for Output Descriptors in Worldcoin Core

Since Worldcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `wdc1...` for mainnet or `twdc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Worldcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Worldcoin Core wallets, a convenience function `combo` is
