...
Output from `gbuild` will look something like
    ...
    From https://github.com/Worldcoin-Network/worldcoin
...
[worldcoin/gitian.sigs](https://github.com/worldcoin-project/gitian.sigs.wdc/) repository, or if that's not possible create a pull
request. 
