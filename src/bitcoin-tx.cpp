...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " worldcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  worldcoin-tx [options] <hex-tx> [commands]  Update hex-encoded worldcoin transaction\n" +
            "or:     worldcoin-tx [options] -create [commands]   Create hex-encoded worldcoin transaction\n" +
            "\n";
