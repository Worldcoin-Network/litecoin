...
"""Verify that starting worldcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start worldcoin with -h for help text")
        ...
        self.log.info("Start worldcoin with -version for version information")
        ...
        self.log.info("Start worldcoind with -fakearg to make sure it does not start")
